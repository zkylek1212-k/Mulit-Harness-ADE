...
export const translations = {
  en: {
    ...
    usage: {
      ...
      range_7d: '7d',
      range_1d: 'Today',
      rangeHint: 'Token usage',
      totalLabel: 'Tokens · {range}',
      estimated: 'estimated',
      inTip: 'Input + cache write',
      cacheTip: 'Cache read (billed ~10%)',
      outTip: 'Model output'
    },
    vibe: {
      developer: 'Dev',
      vibe: 'Vibe',
      modeTooltip: 'Switch between Developer mode and Vibe Coding mode',
      app: 'App',
      code: '</> Code',
      openDevUrl: 'Open detected dev server in Browser',
      agentWorking: 'Agent is working…',
      agentIdle: 'Agent idle · {n} session(s)',
      noAgent: 'No agent running — start one in the terminal',
      noAppTitle: 'No app running yet',
      noAppDesc: 'Ask the agent to start a dev server — it opens here automatically. Or type a URL above.',
      changedFiles: '{n} file(s) changed',
      changedFilesTitle: 'Files changed by agent',
      clear: 'Clear',
      statusTitle: 'Status',
      ...
      filesTitle: 'Files',
      gitTitle: 'Git',
      noHandoff: 'No .project-memory/handoff.md in this workspace yet.',
      handoffDone: 'Done',
      handoffNotDone: 'Not done',
      handoffNext: 'Next',
      modeSection: 'Work Mode',
      developerTitle: 'Developer Mode',
      developerDesc: 'File tree, editor & Git up front',
      vibeTitle: 'Vibe Coding Mode',
      vibeDesc: 'Tasks, agent chat & live result'
    },
    settings: {
      title: 'Settings',
      ...
      appearanceDesc: 'Changes on this page apply instantly — no need to save.',
      ...
      lightModeSub: 'Clean Apple-style light',
      darkModeSub: 'Classic dark',
      lightMorandiSub: 'Soft muted light tones',
      darkMorandiSub: 'Soft muted dark tones',
  ...
  'zh-TW': {
    ...
    vibe: {
      developer: 'Dev',
      vibe: 'Vibe',
      modeTooltip: '切換開發者模式／Vibe Coding 模式',
      app: '成品',
      code: '</> 程式碼',
      openDevUrl: '在內建瀏覽器開啟偵測到的開發伺服器',
      agentWorking: 'Agent 工作中…',
      agentIdle: 'Agent 待命中 · {n} 個會話',
      noAgent: '尚無 Agent 執行——在終端開一個',
      noAppTitle: '還沒有執行中的 App',
      noAppDesc: '請 Agent 把 dev server 跑起來，偵測到後會自動在這裡開啟；也可以在上方直接輸入網址。',
      changedFiles: '已變更 {n} 個檔案',
      changedFilesTitle: 'Agent 修改的檔案',
      clear: '清除',
      statusTitle: '狀態',
      devServer: '開發伺服器',
      handoffTitle: '交接（Handoff）',
      sessionsTitle: '會話',
      settingsTitle: '設定',
      filesTitle: '檔案',
      gitTitle: 'Git',
      noHandoff: '此工作區尚無 .project-memory/handoff.md。',
      handoffDone: '已完成',
      handoffNotDone: '未完成',
      handoffNext: '下一步',
      modeSection: '工作模式',
      developerTitle: '開發者模式',
      developerDesc: '檔案樹、編輯器與 Git 置前',
      vibeTitle: 'Vibe Coding 模式',
      vibeDesc: '任務、對話與即時成品'
    },
    settings: {
      title: '偏好設定',
      ...
      appearanceDesc: '此頁的變更會立即套用，不需要按儲存。',
      ...
      lightModeSub: 'Apple 風格明亮介面',
      darkModeSub: '經典深色介面',
      lightMorandiSub: '柔和低飽和淺色調',
      darkMorandiSub: '柔和低飽和深色調',
